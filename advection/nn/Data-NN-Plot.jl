...
FNO_Data =
 [ 156    2         NaN        0.14732429475929493   0.21406275731248733;
  156    4         NaN         0.13883701406228235   0.2198023907840252;
  156    8         NaN         0.1273765354297864    0.1494840533974079;
  156    16        NaN         0.11244011112751487   0.15144135707463974;
  156    32        NaN         0.08686964705180472   0.16165934355022052;
  #  
  312    2          NaN        0.20176373412593818   0.19073670137769136;
  312    4          NaN        0.13686082367665875   0.14888319387458837;
  312    8         NaN         0.1292798470419187    0.14089221532384938;
  312    16         NaN        0.10984872052302727   0.1423940741074964;
  312    32         NaN        0.09150851065388475   0.15440682837596306;
  
  #  
  625    2    NaN      0.13924972246289252   0.17689754164218902;
  625     4   NaN      0.13491478478312494   0.14177297602891922;
  625     8  NaN       0.12824824439585208   0.14181496809124947;
  625    16  NaN       0.1131444073677063    0.14485083962082862;
  625    32   NaN      0.09237072032764554   0.15564713965654373;  
  #  
  1250    2    NaN      0.16392094716429711   0.1655568196117878;
  1250     4   NaN      0.13518089597225189   0.13728790825009346;
  1250     8  NaN       0.1289861882865429   0.13791822636425496;
  1250    16  NaN       0.11087910863608122   0.14177002581655979;
  1250    32   NaN      0.09369939167052507   0.16034921472370625;  
  #  
  2500    2   NaN        0.13731948798447846   0.16085675894320012;
  2500     4   NaN       0.13437189842760563   0.14574280208349227;
  2500     8  NaN        0.1303224521882832    0.1389519686192274;
  2500    16  NaN        0.11557252415716648   0.14208188624978066;
  2500    32   NaN       0.09624609385039658   0.16408271417617798;  
  #  
  5000    2    NaN        0.14038108449429273   0.15462387750148773;
  5000    4   NaN          0.13588077685385944   0.13707658811956644;
  5000     8  NaN         0.13240791840329766   0.1363590141147375;
  5000    16  NaN         0.1215412126550451   0.14053343777284028;
  5000    32  NaN         0.10048962573166936   0.1603648282378912;  
  #  
  10000    2  NaN        0.15173418428078295   0.13827973230853677;
  10000    4  NaN        0.13454464524164797   0.13611278236731886;
  10000    8 NaN         0.13284966098852455   0.13575140339285136;
  10000    16 NaN        0.1232320523605682   0.13813221438005566;
  10000    32 NaN        0.10523619120083749   0.1501739291805774;
  #  
  20000    2   NaN       0.13669491227064282   0.14937098366469145;
  20000    4   NaN       0.13373905710428954   0.13615077067576348;
  20000    8   NaN       0.13262592964693903   0.13488332782052456;
  20000    16  NaN       0.12837139420127497   0.13639375850073993;
  20000    32  NaN       0.11978913526094984   0.1448642684707418
]
...
for i = 1:4
    ax[i].semilogx(PCA_Data[(i+3)*5+1:(i+3)*5+5, 3], PCA_Data[(i+3)*5+1:(i+3)*5+5, 5], color = colors[1], linestyle=linestyle[1], marker = markers[1], fillstyle="none",      label =  nns[1]  )
    ax[i].semilogx(DeepONet_Data[(i+3)*5+1:(i+3)*5+5, 3], DeepONet_Data[(i+3)*5+1:(i+3)*5+5, 5], color = colors[2], linestyle=linestyle[1], marker = markers[2], fillstyle="none", label =  nns[2]  )
    ax[i].semilogx(PARA_Data[(i+3)*5+1:(i+3)*5+5, 3], PARA_Data[(i+3)*5+1:(i+3)*5+5, 5], color = colors[3], linestyle=linestyle[1], marker = markers[3], fillstyle="none",     label =  nns[3]  )
    ax[i].semilogx(FNO_Data[(i+3)*5+1:(i+3)*5+5, 3], FNO_Data[(i+3)*5+1:(i+3)*5+5, 5], color = colors[4], linestyle=linestyle[1], marker = markers[4], fillstyle="none",      label =  nns[4]  )

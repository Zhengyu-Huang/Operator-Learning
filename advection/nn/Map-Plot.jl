...
function input_plot(data, file_name)
    ...
    ax = gca()
    ax.set_title(L"u_0",pad = 10,fontsize=28)   
    ax.spines["top"].set_visible(false)
    ax.spines["right"].set_visible(false)
    ax.spines["left"].set_color("#808080")
    ax.spines["bottom"].set_color("#808080")
    ax[:set_xlim]([0,1])
    ax.set_xlabel(L"x",labelpad=10,fontsize=20)
...
function output_plot(data, file_name)
    ...
    plot(xx, data, "--o", fillstyle="none",markersize=2, color="#a1a1a1")
    ax = gca()
    ax.set_title(L"u(T)",pad = 10,fontsize=28)   
    ax.spines["top"].set_visible(false)
    ax.spines["right"].set_visible(false)
    ax.spines["left"].set_color("#808080")
    ax.spines["bottom"].set_color("#808080")
...
ax[1,1].set_ylabel(L"u_0")
ax[2,1].set_ylabel("True "*L"u(T)")
ax[3,1].set_ylabel("Predicted "*L"u(T)")

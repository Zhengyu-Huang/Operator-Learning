...
for i = 1:4 # test problems
    ...
    ax[i].set_title(probs[i],pad=15,fontsize=10)
...
fig.legend(handles,labels,loc = "upper center",bbox_to_anchor=(0.5,0.93),ncol=4,frameon=false,fontsize=8,handlelength=0)
# fig.text(0.01, 0.5, "Test Error", ha="left", va="center", rotation="vertical",fontsize=14)
plt.savefig("tenk-Error-Cost.pdf")
plt.close("all")
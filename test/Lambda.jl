...
function Helmhotz_Lambda_Test(geometry::String, nex::Int64 = 20, ney::Int64 = 20, porder::Int64 = 2, ngp::Int64 = 3)
    """
    test the Lambda function output: g->∂u/∂n
    ...
    for geometry in ("box","ring", )
        for porder = 1:2
            for level_id = 1:level_n
                ...
                errors[:, level_id] .= Helmhotz_Lambda_Test(geometry, nex, ney, porder, ngp)
                
                @info "Helmhotz Lambda test : ", "nex = ", nex, " ney = ", ney, " geometry = ", geometry, " porder = ", porder 

...
function Poisson_test(geometry::String, nex::Int64 = 20, ney::Int64 = 20, porder::Int64 = 2, ngp::Int64 = 3)
    """
    ...
    for geometry in ("box", "ring")
        for porder = 1:2
            for level_id = 1:level_n
                ...
                errors[level_id] = Poisson_test(geometry, nex, ney, porder, ngp)
                
                @info "Poisson test : ", "nex = ", nex, " ney = ", ney, " geometry = ", geometry,  " porder = ", porder 
